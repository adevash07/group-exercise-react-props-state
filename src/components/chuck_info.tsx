const ChuckInfo = ({
  ...
  info: { whalesSaved: number; roundHouseKicks: number };
}) => {
  ...
  return (
    <>
      <p>Number of Whales Saved: {info.whalesSaved} </p>

      <p>
        Number of Round House Kicks (in the last day): {info.roundHouseKicks}{" "}
      </p>
    </>
  );
};
